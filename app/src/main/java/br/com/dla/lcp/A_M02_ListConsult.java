...
public class A_M02_ListConsult extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    void resetStoreProducts_ListConsult(){
        conexaoDAO_ListConsult = new S_ConexaoDAO(A_M02_ListConsult.this);
        ...
        s_M02_listConsult_adapter = new S_M02_ListConsult_Adapter(A_M02_ListConsult.this,
        ...
        recyclerView_ListConsult.setLayoutManager(new LinearLayoutManager(A_M02_ListConsult.this));
    }
