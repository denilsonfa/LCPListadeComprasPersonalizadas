...
public class S_M03_ListLista_Adapter extends RecyclerView.Adapter<S_M03_ListLista_Adapter.HolderListConsult> {

    private Context context;
    private ArrayList selectionList, idListL, nomeList, dataList, checkList;
    int position;

    S_M03_ListLista_Adapter(Context context,
    ...
    public void onBindViewHolder(@NonNull HolderListConsult holder, final int position) {
        ...
        holder.selectionList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, A_M03_ListExtract.class);
